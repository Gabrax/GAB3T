...
struct StartScreen {
    StartScreen() : StartScreenShader("res/shaders/TitleShader.vert", "res/shaders/TitleShader.frag"),
                    PressEnterShader("res/shaders/TitleEnterShader.vert", "res/shaders/TitleEnterShader.frag") ,render(true){}
    ...
    void BindAndLoad() {
        ...
        StartScreenTexture = Util::loadTexture("res/textures/title.png");
        ...
        PressEnterTexture = Util::loadTexture("res/textures/pressEnter.png");
    }

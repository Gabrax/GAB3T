...
struct WinBox {
    WinBox() : BoxShader("res/shaders/MapShader.vert", "res/shaders/MapShader.frag"), WinBoxTexture(0), render(false) {
        textures["playerOwins"] = Util::loadTexture("res/textures/playerOwins.png");
        textures["playerXwins"] = Util::loadTexture("res/textures/playerXwins.png");
        textures["draw"] = Util::loadTexture("res/textures/draw.png");
    }
